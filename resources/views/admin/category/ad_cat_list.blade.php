          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                    <h3 class="card-title">
                        <a href="{{route('admin#addCategory')}}">
                            <button class="btn btn-sm btn-dark text-white">Add Category</button>
                        </a>
                    </h3>

                    <div class="card-tools d-flex">
                            <a href="{{route('admin#downloadCSV')}}">
                                <button class="btn btn-sm bg-success me-1">Download CSV</button>
                            </a>
              ...
              <div class="card-body table-responsive p-0">
                ...
                <div class="me-4 d-flex float-end"><p class="bg-primary p-1">Total = {{$category->total()}}</p></div>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
